...
Start at [`README.md`](integration.md) for the integration path. For what Paper
cannot express and how to detect drift, see
[`tailwind-v4-coverage-and-sync.md`](coverage-and-sync.md).
...
[`paper-mcp-normalization-tests.md`](normalization-evidence.md) F-02.
